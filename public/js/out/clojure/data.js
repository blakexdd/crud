...
return cljs.core.reduce.call(null,(function (result,p__26353){
...
var vec__26357 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__26357,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__26357,(1),null);
var ab = cljs.core.nth.call(null,vec__26357,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_26363 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_26363.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_26364 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_26364.call(null,a,b);
}
});
...
return (function (){var G__26368 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26368__$1)].join('')));
...
//# sourceMappingURL=data.js.map?rel=1602507660252
