...
var o24368 = temp__5733__auto__;
var temp__5733__auto____$1 = (o24368["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o24369 = temp__5733__auto____$1;
return (o24369["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__23726__auto__ = f;
return (o__23726__auto__["toString"]).call(o__23726__auto__);
} else {
return "";
}
...
try{var o__23726__auto___24372 = t;
(o__23726__auto___24372["cljs$lang$ctorPrWriter"]).call(o__23726__auto___24372,t,writer);
}catch (e24371){var __24373 = e24371;
}
...
var char_code = (function (){var o__23726__auto__ = (new String(char$));
return (o__23726__auto__["charCodeAt"]).call(o__23726__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__23726__auto__ = String;
return (o__23726__auto__["fromCharCode"]).call(o__23726__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24374 = num_code;
switch (G__24374) {
case (1):
return (185);
...
var o__23726__auto__ = String;
return (o__23726__auto__["fromCharCode"]).call(o__23726__auto__,superscript_code);
});
/**
...
}catch (e24376){var _e__23733__auto__ = e24376;
return false;
}})())){
...
var vec__24377 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__24377,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24382){
var vec__24383 = p__24382;
var ns_detector = cljs.core.nth.call(null,vec__24383,(0),null);
...
var G__24389 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__24390 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__24389;
remaining_tokens = G__24390;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24380){
...
var vec__24394 = cljs.core.split_with.call(null,(function (p1__24393_SHARP_){
return cljs.core.not_EQ_.call(null,p1__24393_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__24394,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__24394,(1),null);
...
var vec__24400 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__24400,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__24400,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__24403 = cljs.core.rest.call(null,remaining_tokens);
var G__24404 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__24403;
name_tokens = G__24404;
continue;
} else {
...
var vec__24407 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__24407,(0),null);
var arity = cljs.core.nth.call(null,vec__24407,(1),null);
var vec__24410 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__24410,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__24410,(1),null);
var vec__24413 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__24413,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__24413,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__24413,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__24413,(3),null);
...
var vec__24419 = result;
var munged_ns = cljs.core.nth.call(null,vec__24419,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__24419,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__24419,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__24419,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__24419,(4),null);
var arity = cljs.core.nth.call(null,vec__24419,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__24423 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__24423,(0),null);
var args = cljs.core.nth.call(null,vec__24423,(1),null);
var vec__24426 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__24426,(0),null);
var name = cljs.core.nth.call(null,vec__24426,(1),null);
...
var G__24429 = (arity + (1));
var G__24430 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__24431){
var vec__24432 = p__24431;
var arity = cljs.core.nth.call(null,vec__24432,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__24432,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__24435_SHARP_){
return cljs.core.get.call(null,arities,p1__24435_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__24436_SHARP_){
return cljs.core.drop.call(null,(2),p1__24436_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___24443 = arguments.length;
var i__4737__auto___24444 = (0);
while(true){
if((i__4737__auto___24444 < len__4736__auto___24443)){
args__4742__auto__.push((arguments[i__4737__auto___24444]));

var G__24445 = (i__4737__auto___24444 + (1));
i__4737__auto___24444 = G__24445;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__24439){
var vec__24440 = p__24439;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__24440,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq24437){
...
var G__24446 = arg;
var G__24446__$1 = (((G__24446 instanceof cljs.core.Keyword))?G__24446.fqn:null);
switch (G__24446__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__24448__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__24448__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__24448__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__24448__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__24449 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__24449,(0),null);
var fn_name = cljs.core.nth.call(null,vec__24449,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__24449,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__24449,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__24449,(4),null);
var arity = cljs.core.nth.call(null,vec__24449,(5),null);
...
var o__23726__auto__ = f;
return (o__23726__auto__["getBasis"]).call(o__23726__auto__);
});
/**
...
}catch (e24453){var _e__23733__auto__ = e24453;
...
var G__24454 = (obj[cljs.core.first.call(null,path)]);
var G__24455 = cljs.core.rest.call(null,path);
obj = G__24454;
path = G__24455;
continue;
} else {
...
var _STAR_ = (function (accum,p__24456){
var vec__24457 = p__24456;
var bit = cljs.core.nth.call(null,vec__24457,(0),null);
var protocol = cljs.core.nth.call(null,vec__24457,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__24460){
var vec__24461 = p__24460;
var ns = cljs.core.nth.call(null,vec__24461,(0),null);
var name = cljs.core.nth.call(null,vec__24461,(1),null);
var selector = cljs.core.nth.call(null,vec__24461,(2),null);
...
var post_process = (function (p__24465){
var vec__24466 = p__24465;
var munged_name = cljs.core.nth.call(null,vec__24466,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__24466,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__24464_SHARP_){
return (obj[cljs.core.first.call(null,p1__24464_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1602360091993
