...
var len__4736__auto___25039 = arguments.length;
var i__4737__auto___25040 = (0);
while(true){
if((i__4737__auto___25040 < len__4736__auto___25039)){
args__4742__auto__.push((arguments[i__4737__auto___25040]));

var G__25041 = (i__4737__auto___25040 + (1));
i__4737__auto___25040 = G__25041;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq25036){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25037,G__25038,seq25036__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__25042_SHARP_){
return (!((cljs.core.meta.call(null,p1__25042_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__25043__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e25047){var _e__24272__auto__ = e25047;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e25049){var _e__24272__auto__ = e25049;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__25051 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__25052 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__25052);

try{var map__25053 = opts;
...
var markup_db = cljs.core.get.call(null,map__25053__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__25051);
}});
...
var temp__5733__auto___25058 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5733__auto___25058)){
var managed_print_level_25059 = temp__5733__auto___25058;
var _STAR_print_level_STAR__orig_val__25056_25060 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__25057_25061 = managed_print_level_25059;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__25057_25061);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__25055_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__25055_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__25056_25060);
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1602418805474
