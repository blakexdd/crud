...
}catch (e30763){var _e = e30763;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___30766 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___30766)){
var seen_errors_30767 = temp__5733__auto___30766;
if(cljs.core.truth_(seen_errors_30767.has(self))){
} else {
seen_errors_30767.add(self);

var temp__5735__auto___30768 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___30768)){
var sense_30769 = temp__5735__auto___30768;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_30769)].join(''));
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1602360096785
