...
return (new CustomEvent(event_name,(function (){var obj32903 = ({"detail":data});
return obj32903;
})()));
} else {
...
var f = (function (){var pred__32910 = cljs.core._EQ_;
var expr__32911 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__32910.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__32911))){
return (function (p1__32904_SHARP_){
return console.warn(p1__32904_SHARP_);
});
} else {
if(cljs.core.truth_(pred__32910.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__32911))){
return (function (p1__32905_SHARP_){
return console.debug(p1__32905_SHARP_);
});
} else {
if(cljs.core.truth_(pred__32910.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__32911))){
return (function (p1__32906_SHARP_){
return console.error(p1__32906_SHARP_);
});
} else {
return (function (p1__32907_SHARP_){
return console.log(p1__32907_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__32914){
...
var opts = map__32915__$1;
var eval_fn = cljs.core.get.call(null,map__32915__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__32917_SHARP_){
return new_def.callback(p1__32917_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__32918){
var vec__32919 = p__32918;
var ky = cljs.core.nth.call(null,vec__32919,(0),null);
var v = cljs.core.nth.call(null,vec__32919,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1602418811667
