...
return (new CustomEvent(event_name,(function (){var obj33135 = ({"detail":data});
return obj33135;
})()));
} else {
...
var f = (function (){var pred__33142 = cljs.core._EQ_;
var expr__33143 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__33142.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__33143))){
return (function (p1__33136_SHARP_){
return console.warn(p1__33136_SHARP_);
});
} else {
if(cljs.core.truth_(pred__33142.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__33143))){
return (function (p1__33137_SHARP_){
return console.debug(p1__33137_SHARP_);
});
} else {
if(cljs.core.truth_(pred__33142.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__33143))){
return (function (p1__33138_SHARP_){
return console.error(p1__33138_SHARP_);
});
} else {
return (function (p1__33139_SHARP_){
return console.log(p1__33139_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__33146){
...
var opts = map__33147__$1;
var eval_fn = cljs.core.get.call(null,map__33147__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__33149_SHARP_){
return new_def.callback(p1__33149_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__33150){
var vec__33151 = p__33150;
var ky = cljs.core.nth.call(null,vec__33151,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1602507665385
