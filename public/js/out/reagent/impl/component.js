...
if((i < len)){
var k = (ks[i]);
var G__24202 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),goog.object.get(o,k));
var G__24203 = (i + (1));
m = G__24202;
i = G__24203;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__24205 = c;
var G__24205__$1 = (((G__24205 == null))?null:G__24205.prototype);
if((G__24205__$1 == null)){
return null;
} else {
return G__24205__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__24207 = c;
var G__24207__$1 = (((G__24207 == null))?null:G__24207.prototype);
if((G__24207__$1 == null)){
return null;
} else {
return G__24207__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__24210__delegate = function (args){
...
while (G__24211__i < G__24211__a.length) {G__24211__a[G__24211__i] = arguments[G__24211__i + 0]; ++G__24211__i;}
  args = new cljs.core.IndexedSeq(G__24211__a,0,null);
} 
...
var args = cljs.core.seq(arglist__24212);
...
var G__24214 = c;
var G__24214__$1 = (((G__24214 == null))?null:G__24214.constructor);
if((G__24214__$1 == null)){
return null;
} else {
return G__24214__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__24215 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__24216 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__24216);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__24215);
}});
...
var c = this;
var G__24220_24222 = goog.object.get(c,"cljsRatom");
if((G__24220_24222 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__24220_24222);
}
...
var renders_24223 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_24224 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_24223));
...
if((cljs.core.count.call(null,renders_24223) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_24223))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_24224)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_24224)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__24225 = o;
goog.object.set(G__24225,cljs.core.name.call(null,k),v);
...
//# sourceMappingURL=component.js.map?rel=1602351793784
