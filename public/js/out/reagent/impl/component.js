...
if((i < len)){
var k = (ks[i]);
var G__24023 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),goog.object.get(o,k));
var G__24024 = (i + (1));
m = G__24023;
i = G__24024;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__24026 = c;
var G__24026__$1 = (((G__24026 == null))?null:G__24026.prototype);
if((G__24026__$1 == null)){
return null;
} else {
return G__24026__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__24028 = c;
var G__24028__$1 = (((G__24028 == null))?null:G__24028.prototype);
if((G__24028__$1 == null)){
return null;
} else {
return G__24028__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__24031__delegate = function (args){
...
while (G__24032__i < G__24032__a.length) {G__24032__a[G__24032__i] = arguments[G__24032__i + 0]; ++G__24032__i;}
  args = new cljs.core.IndexedSeq(G__24032__a,0,null);
} 
return G__24031__delegate.call(this,args);};
G__24031.cljs$lang$maxFixedArity = 0;
G__24031.cljs$lang$applyTo = (function (arglist__24033){
var args = cljs.core.seq(arglist__24033);
return G__24031__delegate(args);
});
...
var G__24035 = c;
var G__24035__$1 = (((G__24035 == null))?null:G__24035.constructor);
if((G__24035__$1 == null)){
return null;
} else {
return G__24035__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__24036 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__24037 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__24037);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__24036);
}});
...
var G__24038 = key;
var G__24038__$1 = (((G__24038 instanceof cljs.core.Keyword))?G__24038.fqn:null);
switch (G__24038__$1) {
...
var c = this;
var G__24041_24043 = goog.object.get(c,"cljsRatom");
if((G__24041_24043 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__24041_24043);
}
...
var renders_24044 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_24045 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_24044));
...
if((cljs.core.count.call(null,renders_24044) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_24044))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_24045)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_24045)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__24046 = o;
goog.object.set(G__24046,cljs.core.name.call(null,k),v);
...
//# sourceMappingURL=component.js.map?rel=1602507658134
