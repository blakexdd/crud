...
if((i < len)){
var k = (ks[i]);
var G__24022 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),goog.object.get(o,k));
var G__24023 = (i + (1));
m = G__24022;
i = G__24023;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__24025 = c;
var G__24025__$1 = (((G__24025 == null))?null:G__24025.prototype);
if((G__24025__$1 == null)){
return null;
} else {
return G__24025__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__24027 = c;
var G__24027__$1 = (((G__24027 == null))?null:G__24027.prototype);
if((G__24027__$1 == null)){
return null;
} else {
return G__24027__$1.render;
}
})() == null)))));
});
...
var G__24034 = c;
var G__24034__$1 = (((G__24034 == null))?null:G__24034.constructor);
if((G__24034__$1 == null)){
return null;
} else {
return G__24034__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__24035 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__24036 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__24036);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__24035);
}});
...
var c = this;
var G__24040_24042 = goog.object.get(c,"cljsRatom");
if((G__24040_24042 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__24040_24042);
}
...
var renders_24043 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_24044 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_24043));
...
if((cljs.core.count.call(null,renders_24043) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_24043))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_24044)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_24044)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__24045 = o;
goog.object.set(G__24045,cljs.core.name.call(null,k),v);
...
//# sourceMappingURL=component.js.map?rel=1602418804628
