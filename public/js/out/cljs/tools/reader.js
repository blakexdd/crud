...
var G__26974 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__26974;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__26975 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26975,ch);
...
if(("\\" === ch__$1)){
var ch_26976__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_26976__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_26976__$2);
} else {
}
...
var vec__26985 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26985,(0),null);
var start_column = cljs.core.nth.call(null,vec__26985,(1),null);
...
var G__26988 = cljs.core.conj_BANG_.call(null,a,form);
a = G__26988;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__26989 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__26990 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__26990);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__26989);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__26991 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26991,(0),null);
var start_column = cljs.core.nth.call(null,vec__26991,(1),null);
...
var vec__26994 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26994,(0),null);
var end_column = cljs.core.nth.call(null,vec__26994,(1),null);
...
var start_line = cljs.core.nth.call(null,vec__26997,(0),null);
var start_column = cljs.core.nth.call(null,vec__26997,(1),null);
...
var vec__27000 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27000,(0),null);
var end_column = cljs.core.nth.call(null,vec__27000,(1),null);
...
var start_line = cljs.core.nth.call(null,vec__27003,(0),null);
var start_column = cljs.core.nth.call(null,vec__27003,(1),null);
...
var vec__27006 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27006,(0),null);
var end_column = cljs.core.nth.call(null,vec__27006,(1),null);
...
var sb = (function (){var G__27009 = (new goog.string.StringBuffer());
G__27009.append(initch);
...
var G__27011 = (function (){var G__27010 = sb;
G__27010.append(ch);

return G__27010;
})();
var G__27012 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__27011;
ch = G__27012;
continue;
}
...
switch (G__27015) {
case "\\":
var G__27019 = (function (){var G__27016 = sb;
G__27016.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__27016;
})();
var G__27020 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__27019;
ch = G__27020;
continue;
...
break;
default:
var G__27021 = (function (){var G__27017 = sb;
G__27017.append(ch);

return G__27017;
})();
var G__27022 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__27021;
ch = G__27022;
continue;
...
var vec__27023 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27023,(0),null);
var end_column = cljs.core.nth.call(null,vec__27023,(1),null);
...
var vec__27026 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__27026,(0),null);
var column = cljs.core.nth.call(null,vec__27026,(1),null);
...
var vec__27031 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__27031,(0),null);
var column = cljs.core.nth.call(null,vec__27031,(1),null);
...
var vec__27036 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__27036,(0),null);
var column = cljs.core.nth.call(null,vec__27036,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__27041 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27041,(0),null);
var start_column = cljs.core.nth.call(null,vec__27041,(1),null);
...
var vec__27044 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27044,(0),null);
var end_column = cljs.core.nth.call(null,vec__27044,(1),null);
...
var G__27047 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__27047,true,null,opts,pending_forms);
...
var G__27048 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__27048)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__27048)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__27048)){
...
var _STAR_suppress_read_STAR__orig_val__27049 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__27050 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__27050);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__27049);
}});
...
var G__27051 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__27051,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__27051,rdr,first_line);
...
var G__27055 = matched;
var G__27056 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__27055;
finished = G__27056;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__27057 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__27058 = (function (){var or__4126__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__27058);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__27057);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__27059 = cljs.tools.reader.arg_env;
var arg_env_temp_val__27060 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__27060);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__27061 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__27061,"(");
...
var G__27062 = (i + (1));
var G__27063 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4126__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__27059);
}});
/**
...
var ch = temp__5733__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__27064 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__27064);
...
var G__27065 = cljs.core.next.call(null,s__$1);
var G__27066 = ret;
s__$1 = G__27065;
r = G__27066;
continue;
...
var G__27067 = cljs.core.next.call(null,s);
var G__27068 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__27067;
key_vals = G__27068;
continue;
} else {
...
var gensym_env_orig_val__27073 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__27074 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__27074);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__27073);
}});
...
var temp__5733__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__27075 = token;
var G__27075__$1 = (((G__27075 == null))?null:cljs.core.subs.call(null,G__27075,(1)));
var G__27075__$2 = (((G__27075__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__27075__$1));
var G__27075__$3 = (((G__27075__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__27075__$2));
var G__27075__$4 = (((G__27075__$3 == null))?null:cljs.core.symbol.call(null,G__27075__$3));
if((G__27075__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__27075__$4);
}
})():(function (){var G__27076 = token;
var G__27076__$1 = (((G__27076 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__27076));
if((G__27076__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__27076__$1);
}
})()
));
if(cljs.core.truth_(temp__5733__auto__)){
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__27087,reader){
...
var eof = cljs.core.get.call(null,map__27088__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
//# sourceMappingURL=reader.js.map?rel=1602418807672
